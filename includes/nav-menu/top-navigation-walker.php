...
if (!class_exists('MaisonPhpClassTopNavigationWalker')) {
    class MaisonPhpClassTopNavigationWalker extends Walker_Nav_Menu {

        public $saved_active = array();
        function save_active( $active ) {
            $this->saved_active = $active;
            //bw_trace2();
        }
        function is_active() {
            return $this->saved_active == 'edgtf-active-item';
        }
        ...
        function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            if($depth == 0){
                if ( $this->is_active() ) {
                    $out_div = '<div class="second" style="display:block;"><div class="inner">';
                } else {
